...
//                 'header' => 'Indice',],
            ['attribute'=> 'posizione',
                ...
                'value' => function ($data, $id, $posizione) {                 
                    return Html::a(trim($data['posizione']), ['consrighe/index', 'id' => $data['cchiave'], 'nextpage' => null, 'posizione' => $data['posizione'],'word'=>$data['criga']] ); // $data['name'] for array data, e.g. using SqlDataProvider.
                    }
                ],
